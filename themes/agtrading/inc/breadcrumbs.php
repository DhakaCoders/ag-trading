...
function agtrading_breadcrumbs() {
  ...
  $text['blog']     = 'blog'; // text for the 'Home' link
  ...
  $wrap_before    = '<ul class="a-breadcrumbs clearfix">'; // the opening wrapper tag
  $wrap_after     = '</ul>'; // the closing wrapper tag
  $sep            = '<a href="javascript:void(0)"><i class="fa fa-angle-right" aria-hidden="true"></i></a>'; // separator between crumbs
  $sep_before     = '<li class="delim">'; // tag before separator
  ...
  $home_link      = $link_before . '<a href="' . $home_url . '"' . $link_attr . ' class="home-icon">' . $link_in_before . $text['home'] . $link_in_after . '</a>' . $link_after;
